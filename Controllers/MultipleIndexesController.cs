...
using AzureSearchComplete.Models;
    ...
    public class MultipleIndexesController : Controller
    {
        ...
        public ViewResult Index(string searchString)
        {
            ...
            if (!string.IsNullOrEmpty(searchString))
            {
                ...
                var localtask = this.localDataSourceIndex.Documents.SearchWithHttpMessagesAsync<AzureSearchComplete.Models.SuperHeroModel>(forText, sp);
                var azuretask = this.azureDataSourceIndex.Documents.SearchWithHttpMessagesAsync<AzureSearchComplete.Models.SuperHeroModel>(forText, sp);
        ...
        private void parseSearchResults(SortedList<double, Microsoft.Azure.Search.Models.SearchResult<Models.SuperHeroModel>> sortedList, 
                                        Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Azure.Search.Models.DocumentSearchResult<AzureSearchComplete.Models.SuperHeroModel>> result)
        {
