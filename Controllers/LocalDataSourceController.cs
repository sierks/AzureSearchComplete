...
namespace AzureSearchComplete.Controllers
{
    public class LocalDataSourceController : Controller
    {
        ...
        public ViewResult Search(string searchString)
        {
            ...
            var async = this.queryIndex.Documents.SearchWithHttpMessagesAsync<AzureSearchComplete.Models.SuperHeroModel>(forText, sp);
            Microsoft.Rest.Azure.AzureOperationResponse<Microsoft.Azure.Search.Models.DocumentSearchResult<AzureSearchComplete.Models.SuperHeroModel>> result = async.Result;
            return View(result);
